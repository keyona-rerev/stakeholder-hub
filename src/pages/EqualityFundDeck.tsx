          ...
          <div className="flex-1 rounded-2xl border border-white/10 bg-white/[0.03] p-10 flex flex-col">
            ...
            <ul className="space-y-3 text-[18px] text-white/70 leading-relaxed flex-1">
              {[
                ...
                <>Backed by Bill Gates' <span className="underline hover:text-[hsl(195,85%,50%)] transition-colors cursor-pointer" onClick={() => window.open("https://www.youtube.com/watch?v=b2Z_6HQa_Ks", "_blank")}>Breakthrough Energy</span></>,
